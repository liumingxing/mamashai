...
var label_introduce = Ti.UI.createLabel({
  top: __l(20),
  bottom: __l(20),
  left: __l(10),
  height: Ti.UI.SIZE,
...
http_call(Ti.App.mamashai+"/api/statuses/binded_mobile?"+account_str(), function(e){
  ...
  if (json.code==-1) {
    ...
    label_introduce.text = '您已经绑定过手机号,无需再绑定.'
    get_validate.touchEnabled = false
    submit.touchEnabled = false
    mobile.touchEnabled = false
    validate.touchEnabled = false
  }
})
