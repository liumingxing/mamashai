...
webFXTreeConfig.loadingText = "请稍等...";
//webFXTreeConfig.loadErrorTextTemplate = "装入错误";
//webFXTreeConfig.emptyErrorTextTemplate = "不包含下级单位";
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon) {
	...
	if (this.open)
		...
		// and create loading item if not
		this._loadingItem = new WebFXTreeItem('请稍等...');
		this.add(this._loadingItem);
	}
}
