...
//服务器异步通知页面路径
$notify_url = "http://www.mamashai.com/api/gou/notify_url";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = "http://www.mamashai.com/api/gou/callback_url";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//操作中断返回地址
$merchant_url = "http://www.mamashai.com/api/gou/interrupt_url";
...
//建立请求
$alipaySubmit = new AlipaySubmit($alipay_config);
$html_text = $alipaySubmit->buildRequestForm($parameter, 'get', '正在载入...');
echo $html_text;
?>
</body>
</html>
