...
$partner		= "2088401540748113";

//安全检验码，以数字和字母组成的32位字符
$key   			= "rht1k19cqovmpk8rn2sjeuunv97f7mml";

//签约支付宝账号或卖家支付宝帐户
$seller_email	= "bd.mamashai@gmail.com";

//交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$notify_url		= "http://www.mamashai.com/orders/notify_add_cash";

//付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
//return_url的域名不能写成http://localhost/js_php_utf8/return_url.php ，否则会导致return_url执行无效
$return_url		= "http://www.mamashai.com/orders/return_add_cash";

//网站商品的展示地址，不允许加?id=123这类自定义参数
$show_url		= "http://www.mamashai.com/tuan";

//收款方名称，如：公司名称、网站名称、收款人姓名等
$mainname		= "北京晒晒乐网络科技有限公司";
